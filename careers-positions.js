/*
  Edit this list to manage the Careers page.

  To add a position:
  1. Copy one full position object.
  2. Paste it below the last object.
  3. Change the slug, title, location, department, type, summary, responsibilities, requirements, and optional partnerLogo.
...
window.ALKHWARIZMI_OPEN_POSITIONS = [
  {
    ...
    requirements: [
      ...
      "Must be based in Akre, Bardarash, or Shekhan.",
